...
// $resultados = glob('*.{php,html,txt}', GLOB_BRACE);//devulveme todos los archivos con esa extension
// print_r($resultados);

// echo basename('carpeta1/carpeta2/archivo.php', '.php');//solo obtiene el nombre del archivo
