	...
	peticion.onload = function(){
		...
		if(datos.error){
			...
			for(var i = 0; i < datos.length; i++){
				...
				elemento.innerHTML += ("<td>" + datos[i].idCalibracion + "</td>");
				elemento.innerHTML += ("<td>" + datos[i].calibreCave + "</td>");
				elemento.innerHTML += ("<td>" + datos[i].tipoCali + "</td>");
				elemento.innerHTML += ("<td>" + datos[i].variedad + "</td>");
				elemento.innerHTML += ("<td>" + datos[i].codigoCali + "</td>");
